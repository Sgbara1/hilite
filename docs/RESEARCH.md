...
| YouTube transcript panel + copy + summarize | ✅ | Panel beside the player: clickable timestamps, copy (plain/timestamped), Summarize with Claude/ChatGPT (URL prefill) and Gemini/AI Studio (input-box injection — neither supports URL prefill natively), save lines to library |
